...
// ----------------------------------------------------------------------------
void PhysicsEngine::initializeWorld_AuxeticCell(void)
{
	...
	// cell -------------------------------------------------------------------
	glm::dvec3 d3Center_Cell = 0.5*d3_Length_Grid + 1.01*dOffset*glm::dvec3(1.0, 1.0, 1.0);

	glm::dvec3 d3Dimensions_Cell = 0.2*d3_Length_Grid;
	d3Dimensions_Cell.x = 0.1*d3_Length_Grid.x;
	d3Dimensions_Cell.z = 1.01*dOffset;

	std::vector<MaterialPoint *> thisMaterialDomain_Wall = MP_Factory.createDomain_AuxeticCell(d3Center_Cell, d3Dimensions_Cell, dOffset);
