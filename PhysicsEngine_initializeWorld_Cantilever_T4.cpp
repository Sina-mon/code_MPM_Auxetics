...
// ----------------------------------------------------------------------------
void PhysicsEngine::initializeWorld_Cantilever_T4(void)
{
...
//	double dRadius_Inner = 0.5*0.02850 - 0.0009;
	...
	double dRadius_Inner = 0.5*0.02540 - 0.00093;
//	double dRadius_Outer = 0.5*0.02540;
//	double dRadius_Inner = 0.5*0.02540 - 0.0013;
	...
	std::vector<MaterialPoint *> thisMaterialDomain1 = MP_Factory.createDomain_Tube_T4(d3Center, dRadius_Outer, dRadius_Inner, 0.0, dOffset);
