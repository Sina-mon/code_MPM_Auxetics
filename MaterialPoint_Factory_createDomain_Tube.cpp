...
//							if(glm::abs(dRadius_Inner - dRadialDistance) < dSurface)	thisMaterialPoint->b_Surface = true;
//							if(glm::abs(dRadius_Outer - dRadialDistance) < dSurface)	thisMaterialPoint->b_Surface = true;
					if(glm::abs(0.5*dLength - dz) < dSurface)				thisMaterialPoint->b_Surface = true;
